...
<head>
	...
	<link rel="shortcut icon" href="webroot/css1/images/gt_favicon.png">
	
	<!-- Bootstrap itself -->
	<link href="http://netdna.bootstrapcdn.com/bootstrap/3.0.3/css/bootstrap.min.css" rel="stylesheet" type="text/css">

	<!-- Custom styles -->
	<link rel="stylesheet" href="webroot/css1/css/magister.css">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">	
				...
				<h1 class="title">Bienvenue a OFMS</h1>
...
<script src="webroot/css1/js/magister.js"></script>
</body>
</html>
